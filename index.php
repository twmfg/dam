...
<html lang="en">
    <head>
        ...
        <link href="css/lasu-festava-live.css" rel="stylesheet">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12 col-12 d-flex flex-wrap">
                            <p class="d-flex me-4 mb-0">
                                ...
                                <strong class="text-dark">Welcome to LASU Music Festival 2024-2025</strong>
                            </p>
                        </div>
                ...
                <div class="container d-flex justify-content-center align-items-center">
                    <div class="row">
                        ...
                        <div class="col-12 mt-auto mb-5 text-center">
                            ...
                            <h1 class="text-white mb-5">Lagos State University <br> Night Live 2024</h1>
                        ...
                        <div class="col-lg-12 col-12 mt-auto d-flex flex-column flex-lg-row text-center">
                            ...
                            <div class="social-share">
                              ...
                              <li class="social-icon-item">
                                        <a href="https://www.facebook.com/lasuinfo/" class="social-icon-link">
                                            <span class="bi-facebook"></span>
                                        </a>
                                    </li>

                                    <li class="social-icon-item">
                                        <a href="https://x.com/LASUOfficial" class="social-icon-link">
                                            <span class="bi-twitter"></span>
                                        </a>
                                    </li>

                                    <li class="social-icon-item">
                                        <a href="https://www.instagram.com/lasuofficialpage/" class="social-icon-link">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-12 mb-4 mb-lg-0 d-flex align-items-center">
                            <div class="services-info">
                                ...
                                <p class="text-white">Welcome to Festava 2024, the ultimate night of music, culture, and
                                    celebration at Lagos State University! This year’s event promises to be bigger and
                                    better, bringing together Nigeria’s top musical icons like Davido, Wizkid, and a
                                    lineup of electrifying performers for a night you’ll never forget.</p>

                                <h6 class="text-white mt-4">Once in Lifetime Experience</h6>

                                <p class="text-white">Festava is LASU’s most anticipated annual music festival, uniting
                                    students, alumni, and music lovers from all over Nigeria.</p>

                                <h6 class="text-white mt-4">Whole Night Party</h6>

                                <p class="text-white">Whether you’re a fan of Afrobeats, hip hop, or live DJ sets,
                                    Festava 2024 has something for everyone!</p>
                            </div>
                        </div>
                ...
                <div class="container">
                    <div class="row justify-content-center">
                        ...
                        <div class="col-lg-5 col-12">
                            <div class="artists-thumb">
                                <div class="artists-image-wrap">
                                    <img src="images/artists/wiz.jpeg">
                                </div>
                                ...
                                <div class="artists-hover">
                                    ...
                                    <p>
                                        <strong>Music:</strong>
                                        Afrobeats, Afro-pop, Reggae, Dancehall, Hip Hop
                                    </p>
                        ...
                        <div class="col-lg-5 col-12">
                            <div class="artists-thumb">
                                <div class="artists-image-wrap">
                                    <img src="./images/artists/davido.jpeg" width="550">
                                </div>
                                ...
                                <div class="artists-hover">
                                    ...
                                    <p>
                                        <strong>Music:</strong>
                                        Afrobeats, Afro-pop, Afro-fusion, Hip Hop
                                    </p>
                            ...
                            <div class="artists-thumb">
                                <img src="images/artists/burna.jpeg" width="550">
                                ...
                                <div class="artists-hover">
                                    ...
                                    <p>
                                        <strong>Music:</strong>
                                         Afrobeats, Afro-fusion, Dancehall, Reggae, Hip Hop
                                    </p>
                        ...
                        <div class="col-lg-8 col-12 mx-auto">
                            ...
                            <div class="tab-content shadow-lg mt-5" id="nav-tabContent">
                                ...
                                <div class="tab-pane fade" id="nav-ContactMap" role="tabpanel" aria-labelledby="nav-ContactMap-tab">
                                    <iframe
                                        src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d495.5546626854968!2d3.2005897042793885!3d6.466154741311154!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x103b8696500590b1%3A0xf27b47e41fad6dab!2sLagos%20State%20University!5e0!3m2!1sen!2sus!4v1726812563516!5m2!1sen!2sus"
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-lg-3 col-12 mt-5">
                            <p class="copyright-text">Copyright © 2024 LASU Festava Live</p>
                        </div>
